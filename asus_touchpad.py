...
alt_key = EV_KEY.KEY_LEFTALT
f4_key = EV_KEY.KEY_F4
...
dev.enable(EV_KEY.KEY_LEFTALT)
dev.enable(EV_KEY.KEY_F4)
...
def launch_calculator():
    try:
        events = [
        	InputEvent(alt_key, 1),  # Alt ditekan
                InputEvent(f4_key, 1),   # F4 ditekan
                InputEvent(EV_SYN.SYN_REPORT, 0),  # Mengirim report

                InputEvent(f4_key, 0),   # F4 dilepas
                InputEvent(EV_SYN.SYN_REPORT, 0),  # Mengirim report

                InputEvent(alt_key, 0),  # Alt dilepas
                InputEvent(EV_SYN.SYN_REPORT, 0)   # Mengirim report
